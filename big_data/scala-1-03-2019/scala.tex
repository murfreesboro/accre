...
Here the variable is more like a conceptual symbol. Here as in the example below, 
...
x = PI*x^{2}
\end{equation}
This is very common for coding. However this expression is mathematically not correct. In this sense, FP concentrates on higher level of abstraction than the IP.


\end{frame}

% -------------------------------------------------------------
\subsection{The difference on functions}
\begin{frame}[fragile]
