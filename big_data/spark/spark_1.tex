...
RDD is simply a collection of data records. It supports both structured data and unstructured data. 
A similar thing to RDD is the data block in HDFS. Both data block in HDFS and RDD 
is like a collection of the targeting data source, in unit of 64MB-128MB(default is 128MB for RDD and HDFS). 
